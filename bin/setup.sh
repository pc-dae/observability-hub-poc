...
argocd app create core-services --repo https://github.com/pc-dae/observability-hub-poc.git --path local-cluster/core --dest-server https://kubernetes.default.svc --dest-namespace argocd --sync
